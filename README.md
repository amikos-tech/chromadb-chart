...
| `chromadb.auth.enabled`                             | boolean | `false`                                | A flag to enable/disable authentication in Chroma. **Note**: This is not supported in Chroma version 1.0.0 or later.                                                                                                                                                                                       |
| `chromadb.auth.type`                                | string  | `basic`                               | Type of auth. Currently "token" (apiVersion>=0.4.8) and "basic" (apiVersion>=0.4.7) are supported. **Note**: This is not supported in Chroma version 1.0.0 or later.                                                                                                                                       |
